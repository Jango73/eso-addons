...
function NoteRenderer:CreateControls()
    ...
    notesBg:SetEdgeTexture("", MINIMAP_EDGE_INSET, MINIMAP_EDGE_INSET, MINIMAP_EDGE_BLEND_MODE)
    ...
    addBg:SetEdgeTexture("", MINIMAP_EDGE_INSET, MINIMAP_EDGE_INSET, MINIMAP_EDGE_BLEND_MODE)
...
function NoteRenderer:CreateEditor()
    ...
    editorBg:SetEdgeTexture("", MINIMAP_EDGE_INSET, MINIMAP_EDGE_INSET, MINIMAP_EDGE_BLEND_MODE)
